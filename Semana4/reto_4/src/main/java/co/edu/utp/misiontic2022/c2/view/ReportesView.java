...
public class ReportesView {
    ...
    public static String repitaCaracter(Character caracter, Integer veces) {
        String respuesta = "";
    ...
    public void totalAdeudadoPorProyectosSuperioresALimite(Double limiteInferior) {
        ...
        if (limiteInferior != null) {
            ...
            try {
                List<DeudasPorProyectoVo> pDeudas = controller.listarTotalAdeudadoProyecto(limiteInferior);
    ...
    public void lideresQueMasGastan() {
        ...
        try {
            List<ComprasDeLiderVo> pCompras = controller.listarLiederesQueMasGastan();
            for (ComprasDeLiderVo pCompra : pCompras) {
